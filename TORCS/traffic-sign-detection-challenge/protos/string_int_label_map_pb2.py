...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='tsd.protos',
  serialized_pb=_b('\n!protos/string_int_label_map.proto\x12\ntsd.protos\"G\n\x15StringIntLabelMapItem\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\x05\x12\x14\n\x0c\x64isplay_name\x18\x03 \x01(\t\"D\n\x11StringIntLabelMap\x12/\n\x04item\x18\x01 \x03(\x0b\x32!.tsd.protos.StringIntLabelMapItem')
)
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
  ...
  full_name='tsd.protos.StringIntLabelMapItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tsd.protos.StringIntLabelMapItem.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='tsd.protos.StringIntLabelMapItem.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='tsd.protos.StringIntLabelMapItem.display_name', index=2,
...
_STRINGINTLABELMAP = _descriptor.Descriptor(
  ...
  full_name='tsd.protos.StringIntLabelMap',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='item', full_name='tsd.protos.StringIntLabelMap.item', index=0,
...
StringIntLabelMapItem = _reflection.GeneratedProtocolMessageType('StringIntLabelMapItem', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:tsd.protos.StringIntLabelMapItem)
  ))
...
StringIntLabelMap = _reflection.GeneratedProtocolMessageType('StringIntLabelMap', (_message.Message,), dict(
  ...
  __module__ = 'protos.string_int_label_map_pb2'
  # @@protoc_insertion_point(class_scope:tsd.protos.StringIntLabelMap)
  ))
