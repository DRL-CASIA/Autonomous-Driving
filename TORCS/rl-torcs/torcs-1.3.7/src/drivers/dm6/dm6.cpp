/***************************************************************************
    ...
    file                 : dm6.cpp
    created              : 2019年 03月 30日 星期六 01:14:48 CST
 ...
 */ 
extern "C" int 
dm6(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm6");		/* name of the module (short) */
...
extern float* pdm6_x;
extern float* pdm6_y;
extern float* pdm6_dist_raced;
extern float* pdm6_speed;
extern float* pdm6_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm6_x = car_x;
    *pdm6_y = car_y;
    *pdm6_dist_raced = dist_raced;
    *pdm6_speed = speed_x;
    *pdm6_to_track_middle_m = to_track_middle_m;
