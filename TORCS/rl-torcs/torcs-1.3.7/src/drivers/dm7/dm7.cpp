 ...
 */ 
extern "C" int 
dm7(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm7");		/* name of the module (short) */
...
extern float* pdm7_x;
extern float* pdm7_y;
extern float* pdm7_dist_raced;
extern float* pdm7_speed;
extern float* pdm7_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm7_x = car_x;
    *pdm7_y = car_y;
    *pdm7_dist_raced = dist_raced;
    *pdm7_speed = speed_x;
    *pdm7_to_track_middle_m = to_track_middle_m;
