/***************************************************************************
    ...
    file                 : dm4.cpp
    created              : 2019年 03月 30日 星期六 01:14:37 CST
 ...
 */ 
extern "C" int 
dm4(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm4");		/* name of the module (short) */
...
extern float* pdm4_x;
extern float* pdm4_y;
extern float* pdm4_dist_raced;
extern float* pdm4_speed;
extern float* pdm4_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm4_x = car_x;
    *pdm4_y = car_y;
    *pdm4_dist_raced = dist_raced;
    *pdm4_speed = speed_x;
    *pdm4_to_track_middle_m = to_track_middle_m;
