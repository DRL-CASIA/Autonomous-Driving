/***************************************************************************
    ...
    file                 : dm9.cpp
    created              : 2019年 04月 04日 星期四 19:35:53 CST
 ...
 */ 
extern "C" int 
dm9(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm9");		/* name of the module (short) */
...
extern float* pdm9_x;
extern float* pdm9_y;
extern float* pdm9_dist_raced;
extern float* pdm9_speed;
extern float* pdm9_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm9_x = car_x;
    *pdm9_y = car_y;
    *pdm9_dist_raced = dist_raced;
    *pdm9_speed = speed_x;
    *pdm9_to_track_middle_m = to_track_middle_m;
