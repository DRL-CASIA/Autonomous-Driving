 ...
 */ 
extern "C" int 
dm2(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm2");		/* name of the module (short) */
...
extern float* pdm2_x;
extern float* pdm2_y;
extern float* pdm2_dist_raced;
extern float* pdm2_speed;
extern float* pdm2_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm2_x = car_x;
    *pdm2_y = car_y;
    *pdm2_dist_raced = dist_raced;
    *pdm2_speed = speed_x;
    *pdm2_to_track_middle_m = to_track_middle_m;
