 ...
 */ 
extern "C" int 
dm8(tModInfo *modInfo) 
{
    memset(modInfo, 0, 10*sizeof(tModInfo));

    modInfo->name    = strdup("dm8");		/* name of the module (short) */
...
extern float* pdm8_x;
extern float* pdm8_y;
extern float* pdm8_dist_raced;
extern float* pdm8_speed;
extern float* pdm8_to_track_middle_m;
/* Drive during race. */
static void  
...
{ 
    ...
    *pdm8_x = car_x;
    *pdm8_y = car_y;
    *pdm8_dist_raced = dist_raced;
    *pdm8_speed = speed_x;
    *pdm8_to_track_middle_m = to_track_middle_m;
